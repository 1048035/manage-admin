<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="userList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="销售积分" align="center" prop="saleScore" />
      <el-table-column label="分红积分" align="center" prop="shareScore" />
      <el-table-column label="提现积分" align="center" prop="withDrawScore" />
      <el-table-column label="转让积分" align="center" prop="transferScore" />
      <el-table-column label="黄金" align="center" prop="shareholding" />
...
import { list, get, del, update } from "@/api/fhorder/statistics";
