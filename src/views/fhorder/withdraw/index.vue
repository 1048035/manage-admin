<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="userList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="提现人手机号" align="center" prop="phone" />
      <el-table-column label="银行卡姓名" align="center" prop="bankName" />
      <el-table-column label="银行卡号" align="center" prop="bankCard" />
      <el-table-column label="银行名称" align="center" prop="bankType" />
      <el-table-column label="开户支行" align="center" prop="bankOpen" />
      <el-table-column label="提现积分" align="center" prop="score" />
      <el-table-column label="实际到账积分" align="center" prop="realScore" />
      <el-table-column label="手续费" align="center" prop="feeScore" />
      <el-table-column label="审批状态" align="center" prop="status">
        <template slot-scope="scope">
          <dict-tag :options="dict.type.payment_check_status" :value="scope.row.status"/>
        </template>
      </el-table-column>
      <el-table-column label="备注" align="center" prop="remark" />
      <el-table-column label="提现时间" align="center" prop="createTime" width="180">
        <template slot-scope="scope">
...
import { list, get, del, update } from "@/api/fhorder/withdraw";
