<template>
  <div class="app-container">
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleAdd"
          v-hasPermi="['fhconfig:banner:add']"
        >新增</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="single"
          @click="handleUpdate"
          v-hasPermi="['fhconfig:banner:edit']"
        >修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['fhconfig:banner:remove']"
        >删除</el-button>
      </el-col>
      <!-- <el-col :span="1.5">
        <el-button
    ...
    <el-table v-loading="loading" :data="bannerList" @selection-change="handleSelectionChange">
            ...
            <template slot-scope="props">
                <el-form label-position="left" class="demo-table-expand">
                            ...
                            <el-form-item label="图片" style="margin-bottom: 0px">
                                <span>
                                    <image-preview :src="props.row.bannerUrl" :width="50" :height="50"/>
                                </span>
                            </el-form-item>
      ...
      <el-table-column label="图片" align="center" prop="bannerUrl" width="100">
...
<script>
import { listBanner, getBanner, delBanner, addBanner, updateBanner } from "@/api/fhconfig/banner";
